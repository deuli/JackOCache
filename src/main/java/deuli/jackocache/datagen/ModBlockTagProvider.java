    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        this.tag(BlockTags.MINEABLE_WITH_AXE)
                .add(ModBlocks.SINISTER_PUMPKIN.get(),
                        ...
                        ModBlocks.SPOOKYJAM_PUMPKIN.get(),
                        ModBlocks.SPOOKYJAM_JACK_O_LANTERN.get()
                );
        ...
        this.tag(ModBlockTags.CARVED_PUMPKINS)
                .add(ModBlocks.SINISTER_PUMPKIN.get(),
                        ModBlocks.GENERIC_PUMPKIN.get(),
                        ModBlocks.CREEPER_PUMPKIN.get(),
                        ModBlocks.ENDERMAN_PUMPKIN.get(),
        ...
        this.tag(ModBlockTags.JACK_O_LANTERNS)
                .add(ModBlocks.SINISTER_JACK_O_LANTERN.get(),
                        ModBlocks.GENERIC_JACK_O_LANTERN.get(),
                        ModBlocks.CREEP_O_LANTERN.get(),
                        ModBlocks.END_O_LANTERN.get(),
                        ModBlocks.BONE_O_LANTERN.get(),
        ...
        this.tag(ModBlockTags.PUMPKINS).addTags(ModBlockTags.CARVED_PUMPKINS, ModBlockTags.JACK_O_LANTERNS);
    }
}